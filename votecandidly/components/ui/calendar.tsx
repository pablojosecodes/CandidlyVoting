  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-neutral-800 text-neutral-700-foreground",
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-neutral-800/50 aria-selected:text-muted-foreground aria-selected:opacity-30",
        day_disabled: "text-muted-foreground opacity-50",
        day_range_middle:
          "aria-selected:bg-neutral-800 aria-selected:text-neutral-700-foreground",
