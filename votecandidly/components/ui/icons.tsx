...
export const Icons = {
  person: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
      <path fill="currentColor" fill-rule="evenodd" d="M10.543 2.41a6.5 6.5 0 1 1-1.276-.794A3.75 3.75 0 0 1 12.35 0h.899a.75.75 0 0 1 0 1.5h-.9a2.25 2.25 0 0 0-1.807.91ZM6.5 5.125A2.375 2.375 0 0 0 4.125 7.5a.625.625 0 1 1-1.25 0A3.625 3.625 0 0 1 6.5 3.875a.625.625 0 1 1 0 1.25" clip-rule="evenodd" />
    </svg>
  ),
  ...
  cloud: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
      <path fill="currentColor" fill-rule="evenodd" d="M6.913 2.38A5 5 0 1 0 5 12h6a3 3 0 0 0 0-6v.5V6a3.01 3.01 0 0 0-1.065.196a5 5 0 0 0-3.022-3.815Z" clip-rule="evenodd" />
    </svg>
  ),
  ...
  cal: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
      <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
        <path d="M7 13.5a5.5 5.5 0 1 0 0-11a5.5 5.5 0 0 0 0 11M.5 2.5A8.69 8.69 0 0 1 3 .5m10.5 2a8.69 8.69 0 0 0-2.5-2" />
        <path d="M7 5v3h2.5" />
      </g>
    </svg>
  ...
  beta: (props: IconProps) => (
    ...
    // <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
    //   <path fill="currentColor" fill-rule="evenodd" d="M7.875 0H2.5A1.5 1.5 0 0 0 1 1.5v11A1.5 1.5 0 0 0 2.5 14h9a1.5 1.5 0 0 0 1.5-1.5V5.125H8.5a.625.625 0 0 1-.625-.625zm4.707 3.875L9.125.418v3.457z" clip-rule="evenodd" />
    // </svg>

  ),
  sf: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 384 512" {...props}>
  ...
  logo: (props: IconProps) => (
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
      ...
      <g transform="translate(0.000000,175.000000) scale(0.100000,-0.100000)"
        ...
        <path d="M1455 1425 c-54 -45 -86 -80 -99 -108 -23 -52 -30 -60 -137 -158
l-87 -79 -20 34 c-15 25 -32 38 -61 46 -32 8 -45 19 -63 53 -13 23 -30 42 -37
42 -8 0 -42 -22 -77 -50 -55 -44 -69 -63 -113 -150 -94 -190 -226 -370 -443
-607 -110 -120 -138 -165 -85 -137 39 22 210 147 337 248 69 55 126 98 128 96
2 -1 -17 -44 -43 -94 -25 -51 -43 -96 -40 -101 11 -17 31 -11 70 20 44 35 49
37 35 11 -5 -11 -10 -29 -10 -40 0 -40 10 -34 212 126 29 24 75 62 101 85 27
24 63 52 80 63 l32 20 -19 -29 c-57 -89 -127 -179 -152 -199 -27 -20 -48 -57
-24 -42 22 13 8 -28 -25 -76 -19 -28 -35 -57 -35 -65 0 -23 32 -16 65 15 66
63 267 221 280 221 11 0 11 -7 3 -36 -5 -20 -7 -42 -4 -49 2 -7 -17 -58 -45
-113 -27 -55 -49 -105 -49 -111 0 -47 99 55 366 373 146 175 137 159 125 203
-6 20 -9 38 -7 40 1 2 30 -29 63 -69 98 -119 334 -400 385 -458 32 -37 51 -51
58 -44 7 7 -10 42 -52 109 -132 214 -218 358 -218 366 0 18 31 -5 75 -57 80
-92 119 -60 47 39 -49 67 -97 182 -53 126 35 -45 109 -119 118 -119 5 0 31
-23 58 -50 46 -46 54 -50 92 -49 50 3 57 -2 140 -108 66 -84 119 -127 127
-101 13 41 17 49 31 54 9 4 45 -19 96 -61 109 -90 119 -77 40 54 -63 104 -70
123 -48 118 7 -1 11 6 9 16 -5 26 11 16 124 -82 56 -49 99 -80 104 -75 6 6
-14 40 -48 84 -32 41 -98 127 -146 190 -49 63 -94 121 -100 129 -9 11 -7 13
11 7 16 -5 23 -2 28 13 10 32 -13 63 -120 161 -55 51 -105 104 -110 119 -6 14
-15 33 -20 41 -17 25 -133 130 -144 130 -6 0 -22 -18 -36 -40 -18 -28 -35 -42
-62 -49 -32 -9 -46 -23 -86 -85 -27 -41 -52 -86 -56 -101 l-7 -27 -25 33 c-14
19 -58 86 -98 149 -89 138 -90 139 -126 146 -43 8 -56 18 -80 60 -12 22 -28
40 -36 42 -8 1 -50 -27 -94 -63z m105 30 c0 -27 55 -77 91 -84 33 -6 45 -20
178 -216 78 -115 180 -266 228 -334 47 -68 81 -121 75 -117 -15 9 -209 242
-396 474 -76 95 -141 171 -143 169 -4 -5 164 -294 287 -492 47 -77 90 -147 94
-155 10 -20 -50 47 -186 207 -62 73 -114 130 -116 128 -5 -4 235 -399 382
-627 20 -32 35 -58 32 -58 -2 0 -113 131 -246 290 -134 160 -245 289 -247 286
-2 -2 1 -32 6 -66 l10 -62 -211 -247 c-249 -291 -245 -286 -225 -246 8 17 74
133 145 258 72 125 127 227 123 225 -8 -3 -252 -208 -414 -346 -60 -52 -110
-92 -112 -90 -3 3 89 136 313 456 59 84 114 163 122 175 14 21 14 21 -5 6 -43
-35 -436 -378 -525 -458 -105 -95 -100 -87 46 85 123 146 374 459 374 467 0 4
-46 -32 -102 -79 -64 -52 -118 -108 -143 -144 -56 -84 -183 -224 -283 -317
l-86 -78 78 149 78 149 -79 -70 c-97 -86 -199 -169 -323 -260 -152 -111 -160
-113 -65 -12 207 218 374 445 460 624 39 82 53 100 109 144 35 28 66 51 69 51
2 0 10 -14 17 -30 16 -38 55 -70 86 -70 16 0 29 -11 45 -40 13 -22 26 -39 30
-38 4 2 57 47 118 102 89 79 112 105 117 133 5 27 24 49 88 103 82 70 106 82
106 55z m744 -263 c4 -17 49 -68 121 -137 134 -128 160 -183 40 -85 -41 34
-75 59 -75 55 0 -9 222 -296 379 -490 16 -20 -91 76 -314 279 -150 137 -170
155 -160 136 5 -8 80 -118 165 -245 86 -126 165 -243 176 -260 18 -29 -45 24
-316 262 -57 51 -106 91 -108 89 -6 -7 69 -118 151 -224 43 -57 70 -99 59 -93
-11 6 -35 30 -53 53 -18 24 -111 141 -207 261 l-174 218 66 111 c37 61 65 112
63 114 -2 2 -39 -39 -82 -92 -70 -85 -80 -93 -93 -80 -14 14 -9 24 41 101 32
47 64 85 72 85 28 0 60 22 83 56 l23 35 68 -60 c42 -37 71 -72 75 -89z"/>
        <path d="M1022 1065 c18 -36 38 -65 45 -65 7 0 13 5 13 10 0 11 -79 120 -86
120 -2 0 11 -29 28 -65z"/>
  ...
  guests: (props: IconProps) => (

    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
      <path fill="currentColor" fill-rule="evenodd" d="M5.5 0a1 1 0 0 0-1 1v.5a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1zM3.25 1h-.5a1.5 1.5 0 0 0-1.5 1.5v10a1.5 1.5 0 0 0 1.5 1.5h8.5a1.5 1.5 0 0 0 1.5-1.5v-10a1.5 1.5 0 0 0-1.5-1.5h-.5v.5A2.25 2.25 0 0 1 8.5 3.75h-3A2.25 2.25 0 0 1 3.25 1.5zm.5 7.5a.75.75 0 0 1 .75-.75h5a.75.75 0 0 1 0 1.5h-5a.75.75 0 0 1-.75-.75" clip-rule="evenodd" />
    </svg>
  ),
  mic: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 20 20" {...props}>
      <g fill="currentColor">
  ...
  age: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 32 32"  {...props}>
      <path fill="currentColor" d="M30 16c0 7.732-6.268 14-14 14S2 23.732 2 16S8.268 2 16 2s14 6.268 14 14Zm-5.233 6.645A10.952 10.952 0 0 0 27 16c0-6.075-4.925-11-11-11c-2.497 0-4.8.832-6.645 2.233l2.144 2.145a1.25 1.25 0 0 1 2.058.953v1.105l1.712 1.711a3.881 3.881 0 1 1 6.61 2.195a4.43 4.43 0 0 1 1.672 3.47c0 .758-.19 1.47-.524 2.094l1.74 1.74Zm-2.122 2.122l-1.847-1.848a4.437 4.437 0 0 1-5.79-5.79l-1.45-1.45v5.935a1.25 1.25 0 0 1-2.5 0v-8.36l-.647.618a1.25 1.25 0 0 1-1.727-1.808l.644-.615l-2.095-2.094A10.952 10.952 0 0 0 5 16c0 6.075 4.925 11 11 11c2.497 0 4.8-.832 6.645-2.233Zm-3.393-7.636l1.544 1.543a1.688 1.688 0 0 0-1.544-1.543Zm1.493-4.512a1.63 1.63 0 1 0-3.262 0a1.63 1.63 0 0 0 3.262 0Z" />
    </svg>
  ),
  activities: (props: IconProps) => (

    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
      <path fill="currentColor" fill-rule="evenodd" d="M9.512 6.056L1.693.656C1.297.407.815.474.467.737A1.142 1.142 0 0 0 0 1.632v10.705c0 .884.979 1.456 1.693 1.004l7.82-5.367c.65-.439.65-1.48 0-1.919Zm4.238-4.314a1 1 0 1 0-2 0v10.516a1 1 0 0 0 2 0z" clip-rule="evenodd" />
    </svg>
  ),
  requirements: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
      <path fill="currentColor" fill-rule="evenodd" d="M5.183.5a1.5 1.5 0 0 1 1.492 1.14l.215.86h5.61A1.5 1.5 0 0 1 14 4v8a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 0 12V2A1.5 1.5 0 0 1 1.5.5zM9.6 6.45a.75.75 0 1 0-1.2-.9L5.826 8.982l-.91-.606a.75.75 0 0 0-.832 1.248l1.5 1A.75.75 0 0 0 6.6 10.45z" clip-rule="evenodd" />
    </svg>
  ),
  details: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 16 16" {...props}>
  ...
  userIcon: (props: IconProps) => (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
      <path fill="currentColor" fill-rule="evenodd" d="M14 7a6.977 6.977 0 0 1-1.941 4.838A6.98 6.98 0 0 1 7.02 14h-.04a6.98 6.98 0 0 1-5.039-2.162A7 7 0 1 1 14 7m-2.757 3.5A5.489 5.489 0 0 0 7 8.5a5.489 5.489 0 0 0-4.243 2A5.489 5.489 0 0 0 7 12.5a5.489 5.489 0 0 0 4.243-2M7 7.5a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 5" clip-rule="evenodd" />
    </svg>
  ),
  ...
  map: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24" {...props}>
      <g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
        ...
        <path fill="currentColor" d="M18.364 4.636a9 9 0 0 1 .203 12.519l-.203.21l-4.243 4.242a3 3 0 0 1-4.097.135l-.144-.135l-4.244-4.243A9 9 0 0 1 18.364 4.636zM12 8a3 3 0 1 0 0 6a3 3 0 0 0 0-6z" />
      </g>
    </svg>
  ),
  ...
  branch: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 32 32" {...props}>
      <path fill="currentColor" d="M11 4C9.355 4 8 5.355 8 7c0 1.293.844 2.395 2 2.813v12.37ƒ4c-1.156.418-2 1.52-2 2.813c0 1.645 1.355 3 3 3s3-1.355 3-3c0-1.27-.816-2.344-1.938-2.781c.145-1.23.622-1.836 1.376-2.344c.898-.605 2.277-.965 3.78-1.313c1.505-.347 3.118-.707 4.47-1.656c1.187-.832 2.085-2.195 2.28-4.093C25.142 12.402 26 11.3 26 10c0-1.645-1.355-3-3-3s-3 1.355-3 3c0 1.277.832 2.352 1.969 2.781c-.137 1.313-.645 1.965-1.407 2.5c-.898.63-2.285 1-3.78 1.344c-1.497.344-3.118.648-4.47 1.563c-.109.074-.21.167-.312.25V9.813c1.156-.418 2-1.52 2-2.813c0-1.645-1.355-3-3-3zm0 2c.563 0 1 .438 1 1c0 .563-.438 1-1 1c-.563 0-1-.438-1-1c0-.563.438-1 1-1zm12 3c.563 0 1 .438 1 1c0 .563-.438 1-1 1c-.563 0-1-.438-1-1c0-.563.438-1 1-1zM11 24c.563 0 1 .438 1 1c0 .563-.438 1-1 1c-.563 0-1-.438-1-1c0-.563.438-1 1-1z" />
    </svg>
  ),
  codeline: (props: IconProps) => (

    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 32 32"   {...props}>
      <path fill="currentColor" d="m18 5l-6 22h2l6-22zM7.937 6.406l-6.75 9L.75 16l.438.594l6.75 9l1.625-1.188L3.25 16l6.313-8.406zm16.125 0l-1.625 1.188L28.75 16l-6.313 8.406l1.625 1.188l6.75-9L31.25 16l-.438-.594z" />
    </svg>
  ),
  wrong: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
  ...
  right: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
      <path fill="currentColor" fill-rule="evenodd" d="M3.5 0A3.5 3.5 0 0 0 0 3.5v7A3.5 3.5 0 0 0 3.5 14h7a3.5 3.5 0 0 0 3.5-3.5v-7A3.5 3.5 0 0 0 10.5 0zm7.003 5.219A.75.75 0 0 0 9.33 4.28L5.786 8.714L4.367 7.65a.75.75 0 1 0-.9 1.2l2 1.5a.75.75 0 0 0 1.036-.131z" clip-rule="evenodd" />
    </svg>
  ),
  threeDots: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24" {...props}>
      <path fill="currentColor" fill-rule="evenodd" d="M4.5 12a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0Zm6 0a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0Zm6 0a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0Z" clip-rule="evenodd" />
    </svg>
  ),
  ...
  Accounts: (props: IconProps) => (
    <svg
      ...
      {...props}>
      <path
        d="M12.6783 8.69082C13.3946 8.66484 14.0731 8.36324 14.5723 7.84897C15.0715 7.33471 15.3528 6.64751 15.3575 5.93082C15.3465 5.23113 15.0581 4.56444 14.5557 4.07735C14.0533 3.59025 13.378 3.32262 12.6783 3.33332M13.3333 16.6666V15C13.3333 14.1159 12.9821 13.2681 12.357 12.643C11.7319 12.0178 10.8841 11.6666 10 11.6666H5.83333C4.94928 11.6666 4.10143 12.0178 3.47631 12.643C2.85119 13.2681 2.5 14.1159 2.5 15V16.6666M17.5 16.6666V14.1666C17.5 13.5036 17.2366 12.8677 16.7678 12.3989C16.2989 11.93 15.663 11.6666 15 11.6666M7.8575 8.69082C8.57359 8.66463 9.25192 8.36294 9.75094 7.84869C10.25 7.33445 10.5312 6.64737 10.5358 5.93082C10.5249 5.23128 10.2366 4.56472 9.73436 4.07764C9.23213 3.59057 8.55705 3.32285 7.8575 3.33332C7.15781 3.32262 6.48252 3.59025 5.98011 4.07735C5.4777 4.56444 5.1893 5.23113 5.17833 5.93082C5.18281 6.64757 5.46405 7.33489 5.96329 7.8492C6.46254 8.36351 7.14119 8.66504 7.8575 8.69082Z"
        fill="none"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  home: (props: IconProps) => (
    ...
    <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 14 14" {...props}>
  ...
  send: (props: IconProps) => (
    <svg width="480" height="512" viewBox="0 0 15 16" xmlns="http://www.w3.org/2000/svg" {...props}>
  ...
  twitter: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 432 384" {...props}>
